...
# Comprehensive dictionary of all annotations, mapped to their
# respective keys
annotation_to_key = {
  ...
  "distrusting government or pharmaceutical companies": "3",
  ...
  "inappropriate use of scientific evidence": "7",
  "Inappropriate Use of Scientific and Other Evidence - out of context_verified": "7a",
  "Inappropriate Use of Scientific Evidence - out of context_verified": "7a",
  "less robust evidence or outdated evidence_verified": "7b",
  "less robust evidence or outdated evidence_verify": "7b",
  "lack of citation for evidence": "7c",
  "rhetorical tricks": "8",
  ...
  "lack of evidence or use unverified and incomplete evidence to make a claim": "9c",
  ...
  "title of article": "11c",
  "title of article as clickbait": "11c",
  "bolded words or underline": "11d",
  ...
  "citing seemingly credible source": "12a",
  "citing seemingly credible sources to strengthen one’s arguments": "12a",
  ...
  "surface credibility markers - medical or scientific jargon": "12ci",
...
def convert_to_dataframe(segment_dict, layer):
  ...
  if layer == "1":
    ...
    labels = ["1a", "1b", "1c", "3a", "4a", "4b", "4c", "4d", "7a", "7b", "7c",
              "8a", "9a", "9b", "9c", "9d", "9e", "10a", "10b", "10c", "10d",
              "11a", "11b", "11c", "11d", "11e", "12a", "12b", "12c", "12d"]
  elif layer == "4":
    labels = ["12ai", "12aii", "12aiii", "12aiv", "12bi",
              "12biii", "12ci", "12cii", "12civ"]
  else:
...
class SegmentDataset(torch.utils.data.Dataset):
  ...
  def __getitem__(self, idx):
    ...
    batch_y = torch.tensor(d[1:].tolist(), dtype=torch.float32)
